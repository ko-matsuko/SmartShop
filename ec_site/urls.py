...
urlpatterns = [
    ...
    path("buy/", views.BuyItem.as_view(), name="buy_item"),
    path("recommend/", views.RecommendItems.as_view(),   name="recommend_items"),
    path("buy/confirm/", views.BuyItemCommitGet.as_view(), name="buy_item_commit_get"),
    path("buy/commit/", views.BuyItemCommit.as_view(),    name="buy_item_commit"),
